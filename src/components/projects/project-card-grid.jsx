      ...
      <TooltipTrigger asChild>
        ...
        >
          <CardHeader className="pb-2 px-3 pt-3">
            ...
            <CardDescription className="text-gray-400 text-xs line-clamp-2 mb-2 cursor-pointer">
              {project.description}
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="pb-2 px-3">
            <div className="flex items-center justify-between text-xs text-gray-400">
              ...
              <Badge variant={status.variant} className="text-xs px-1.5 py-0 h-5 w-fit cursor-pointer">
                {status.label}
              </Badge>
            </div>
          </CardContent>
